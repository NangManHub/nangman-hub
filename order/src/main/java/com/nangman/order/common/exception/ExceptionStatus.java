...
public enum ExceptionStatus {
    ...
    COMPANY_NOT_FOUND(HttpStatus.NOT_FOUND, "ORDER_001", "Company를 찾을 수 없습니다."),
    HUB_MANAGER_MISMATCHED(HttpStatus.FORBIDDEN, "ORDER_002", "해당 허브의 담당자가 아닙니다."),
    ...
    ORDER_NOT_FOUND(HttpStatus.NOT_FOUND, "ORDER_008", "Order를 찾을 수 없습니다."),
    DELIVERY_SHIPPER_MISMATCHED(HttpStatus.FORBIDDEN, "ORDER_009", "해당 배송의 담당자가 아닙니다."),
    PRODUCT_NOT_FOUND(HttpStatus.NOT_FOUND, "ORDER_010", "Product를 찾을 수 없습니다.");
