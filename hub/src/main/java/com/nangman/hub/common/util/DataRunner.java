...
public class DataRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        List<Hub> hubList = List.of(
                ...
                new Hub("경기 북부 센터", "경기도 고양시 덕양구 권율대로 570", 37.6403771056018, 126.87379545786, UUID.randomUUID(), hubA),
                new Hub("인천광역시 센터", "인천 남동구 정각로 29", 37.4560499608337, 126.705255744089, UUID.randomUUID(), hubA),
                new Hub("강원특별자치도 센터", "강원특별자치도 춘천시 중앙로 1", 37.8800729197963, 127.727907820318, UUID.randomUUID(), hubA),
                new Hub("충청북도 센터", "충북 청주시 상당구 상당로 82", 36.6353867908159, 127.491428436987, UUID.randomUUID(), hubB),
                new Hub("충청남도 센터", "충남 홍성군 홍북읍 충남대로 21", 36.6590666265439, 126.672978750559, UUID.randomUUID(), hubB),
                new Hub("세종특별자치시 센터", "세종특별자치시 한누리대로 2130", 36.4800579897497, 127.289039408864, UUID.randomUUID(), hubB),
                new Hub("전북특별자치도 센터", "전북특별자치도 전주시 완산구 효자로 225", 35.8194621650578, 127.106396942356, UUID.randomUUID(), hubB),
                new Hub("전라남도 센터", "전남 무안군 삼향읍 오룡길 1", 34.8174988528003, 126.465423854957, UUID.randomUUID(), hubB),
                new Hub("광주광역시 센터", "광주 서구 내방로 111", 35.1600994105234, 126.851461925213, UUID.randomUUID(), hubB),
                new Hub("부산광역시 센터", "부산 동구 중앙대로 206", 35.117605126596, 129.045060216345, UUID.randomUUID(), hubC),
                new Hub("울산광역시 센터", "울산 남구 중앙로 201", 35.5379472830778, 129.311256608093, UUID.randomUUID(), hubC),
                new Hub("경상북도 센터", "경북 안동시 풍천면 도청대로 455", 36.5761205474728, 128.505722686385, UUID.randomUUID(), hubC),
