...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<UUID, ShipperMessage> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<UUID, ShipperMessage> kafkaListenerContainerFactory() {
